...
-- reload nvim
keymap("n", "<Space><Space>", ":source $MYVIMRC<CR>", opts)
...
keymap("n", "<Leader>E", ":Telescope file_browser hidden=true<Cr>", opts)
keymap("n", "<Leader>e", ":Telescope file_browser hidden=true path=%:p:h<CR>", opts)
...
keymap("n", "gf", ":Telescope current_buffer_fuzzy_find<CR>", opts)
keymap("n", "gd", ":Telescope lsp_definitions<CR>", opts)

-- Better error messages
keymap("n", "ge", ":DiagWindowShow<CR>", opts)
